          ...
          <motion.div
            ...
            <div className='flex flex-col gap-4'>
              <p className='text-white font-medium'>
                Desk-grade <span className='text-primary'>portfolio</span>
              </p>
              <h2 className='text-white sm:text-5xl text-3xl mb-4 font-medium'>
                See every wallet, pool, and venue in one book
              </h2>
            </div>
            <p className='text-muted/60 text-lg'>
              Conveyor unifies tokens, LP positions, and execution so operators
