        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            <p className="text-white font-medium">
              Conveyor <span className="text-primary">advantage</span>
            </p>
            <h2 className="text-white sm:text-5xl text-3xl  font-medium mb-5">
              Upgrade how your desk operates
            </h2>
            <p className="text-muted/60 text-lg mb-7">
              Replace fragmented tabs with a single, auditable stack for
              portfolio, liquidity, and trading.
            </p>
