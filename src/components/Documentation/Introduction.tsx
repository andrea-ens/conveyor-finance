      ...
      <div id='version' className='md:scroll-m-[180px] scroll-m-28'>
          ...
          {PackageVersions &&
            PackageVersions.map((item) => {
              return (
                <div
                  key={item.id}
                  className='lg:w-1/5 md:w-full text-center lg:border-b-0 border-b lg:border-e lg:last:border-e-0 last:border-b-0 border-border'>
                  <Image
                    src={item.img}
                    width={64}
                    height={64}
        ...
        <div className='mt-5'>
          <p className='text-base font-medium text-muted/60'>
            The Conveyor website is built with Next.js, Tailwind CSS, and shadcn/ui.
          </p>
          <p className='text-base font-medium text-muted/60'>
