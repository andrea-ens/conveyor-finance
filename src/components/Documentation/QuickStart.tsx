    ...
    <div className='pb-10 md:scroll-m-[180px] scroll-m-28' id='start'>
      ...
      <div className='p-6 rounded-md border mt-6 border-border'>
        ...
        <div className='py-4 px-3 rounded-md bg-dark_grey'>
          ...
          <p className='text-sm text-gray-400 mt-2'>pnpm install</p>
        </div>
        <h6 className='mt-4 mb-2 text-white text-dark font-medium text-base'>
          1) Install with yarn:
        </h6>
        ...
        <h6 className='mt-8 mb-2 text-white text-dark font-medium text-base'>
        ...
        <div className='py-4 px-3 rounded-md bg-dark_grey'>
          <p className='text-sm text-gray-400 font-mono'>npx shadcn@latest add [component-name]</p>
        </div>
      </div>
      <div className='p-6 rounded-md border mt-6 border-border'>
        ...
        <div className='py-4 px-3 rounded-md bg-dark_grey'>
          <p className='text-sm text-gray-400'>npm run dev, pnpm dev or yarn run dev</p>
        </div>
      ...
      <div className='p-6 rounded-md border mt-6 border-border'>
        ...
        <div className='py-4 px-3 rounded-md bg-dark_grey'>
          <p className='text-sm text-gray-400'>npm run build, pnpm build or yarn build</p>
        </div>
